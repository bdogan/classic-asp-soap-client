...
Class oSoapClient
	...
	Private Property Get Utf8Decode(byval UTF82TR_Data)
		...
		UTF82TR_Data = Replace(UTF82TR_Data ,"รฎ","i",1,-1,0)
		...
		UTF82TR_Data = Replace(UTF82TR_Data ,"รข","a",1,-1,0)
		UTF82TR_Data = Replace(UTF82TR_Data ,"รป","u",1,-1,0)
		UTF82TR_Data = Replace(UTF82TR_Data ,"ล","Þ",1,-1,0)
		UTF82TR_Data = Replace(UTF82TR_Data ,"ฤ","ะ",1,-1,0)
		
		UTF82TR_Data = Replace(UTF82TR_Data ,"โ€ฆ","…",1,-1,0)
		UTF82TR_Data = Replace(UTF82TR_Data ,"โ€“","-",1,-1,0)
		UTF82TR_Data = Replace(UTF82TR_Data ,"โ€","’",1,-1,0)
		UTF82TR_Data = Replace(UTF82TR_Data ,"โ€","“",1,-1,0)
		UTF82TR_Data = Replace(UTF82TR_Data ,"โ€?","”",1,-1,0)
		UTF82TR_Data = Replace(UTF82TR_Data ,"โ€z","",1,-1,0)
		UTF82TR_Data = Replace(UTF82TR_Data ,"ยท","ท",1,-1,0)
		UTF82TR_Data = Replace(UTF82TR_Data ,"ร","ย",1,-1,0)
		UTF82TR_Data = RegexReplace("ย.", UTF82TR_Data, "")
